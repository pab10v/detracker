declare module "types:assemblyscript/std/assembly/shared/feature" {
    ...
    export const enum Feature {
        ...
        Strings = 16384,// see: https://github.com/WebAssembly/stringref
        /** Shared-everything threads. */
        SharedEverything = 32768,// see: https://github.com/WebAssembly/shared-everything-threads
        /** All features. */
        All = 65535
    }
...
declare module "types:assemblyscript/src/common" {
    ...
    export namespace CommonNames {
        ...
        const ASC_FEATURE_SHARED_EVERYTHING = "ASC_FEATURE_SHARED_EVERYTHING";
        ...
        const EnumToString = "__enum_to_string";
        const I8 = "I8";
        const I16 = "I16";
        const I32 = "I32";
        const I64 = "I64";
...
declare module "types:assemblyscript/src/diagnosticMessages.generated" {
    ...
    export enum DiagnosticCode {
        ...
        An_interface_or_abstract_method_0_cannot_have_type_parameters = 241,
        Cannot_override_generic_method_0_with_a_non_generic_method_or_vice_versa = 242,
        ...
        A_const_enum_member_can_only_be_accessed_using_a_string_literal = 2476,
...
declare module "types:assemblyscript/src/glue/binaryen" {
    ...
    export function _BinaryenArrayNewData(module: ModuleRef, type: HeapTypeRef, name: StringRef, offset: ExpressionRef, size: ExpressionRef): ExpressionRef;
    ...
    export function _BinaryenArrayNewElem(module: ModuleRef, type: HeapTypeRef, seg: StringRef, offset: ExpressionRef, size: ExpressionRef): ExpressionRef;
    ...
    export function _BinaryenArrayFill(module: ModuleRef, ref: ExpressionRef, index: ExpressionRef, value: ExpressionRef, size: ExpressionRef): ExpressionRef;
    ...
    export function _BinaryenArrayInitData(module: ModuleRef, name: StringRef, ref: ExpressionRef, index: ExpressionRef, offset: ExpressionRef, size: ExpressionRef): ExpressionRef;
    ...
    export function _BinaryenArrayInitElem(module: ModuleRef, seg: StringRef, ref: ExpressionRef, index: ExpressionRef, offset: ExpressionRef, size: ExpressionRef): ExpressionRef;
    ...
    export function _BinaryenStringSliceWTF(module: ExpressionRef, ref: ExpressionRef, start: ExpressionRef, end: ExpressionRef): ExpressionRef;
    ...
    export function _BinaryenSetMemory(module: ModuleRef, initial: Index, maximum: Index, exportName: StringRef, segmentNames: ArrayRef<StringRef>, segmentDatas: ArrayRef<ArrayRef<number>>, segmentPassive: ArrayRef<boolean>, segmentOffsets: ArrayRef<number>, segmentSizes: ArrayRef<number>, numSegments: Index, shared: boolean, memory64: boolean, name: StringRef): void;
    export function _BinaryenGetNumMemorySegments(module: ModuleRef): Index;
    export function _BinaryenGetMemorySegmentByteOffset(module: ModuleRef, segmentName: StringRef): number;
    export function _BinaryenGetMemorySegmentByteLength(module: ModuleRef, segmentName: StringRef): number;
    export function _BinaryenCopyMemorySegmentData(module: ModuleRef, segmentName: StringRef, buffer: ArrayRef<number>): void;
    export function _BinaryenAddDataSegment(module: ModuleRef, segmentName: StringRef, memoryName: StringRef, segmentPassive: boolean, segmentOffset: ExpressionRef, segmentData: ArrayRef<number>, segmentSize: Index): void;
    ...
    export function _BinaryenModuleReadWithFeatures(input: ArrayRef<number>, inputSize: number, featureFlags: FeatureFlags): ModuleRef;
    ...
    export function _BinaryenGetTrapsNeverHappen(): boolean;
    export function _BinaryenSetTrapsNeverHappen(on: boolean): void;
    export function _BinaryenGetClosedWorld(): boolean;
    export function _BinaryenSetClosedWorld(on: boolean): void;
    ...
    export function _BinaryenGetGenerateStackIR(): boolean;
    export function _BinaryenSetGenerateStackIR(on: boolean): void;
    export function _BinaryenGetOptimizeStackIR(): boolean;
    export function _BinaryenSetOptimizeStackIR(on: boolean): void;
    ...
    export function _BinaryenHasPassToSkip(pass: StringRef): boolean;
...
declare module "types:assemblyscript/src/resolver" {
    ...
    import { TypeNode, NamedTypeNode, TypeName, TypeParameterNode, Node, IdentifierExpression, CallExpression, Expression, IntegerLiteralExpression } from "types:assemblyscript/src/ast";
    import { Type } from "types:assemblyscript/src/types";
...
declare module "types:assemblyscript/src/program" {
    ...
    export class Enum extends TypedElement {
        toStringFunctionName: string | null;
...
declare module "types:assemblyscript/src/compiler" {
    ...
    export class Compiler extends DiagnosticEmitter {
        ...
        staticGcObjectOffsets: Map<number, Set<number>>;
...
declare module "types:assemblyscript/src/builtins" {
     ...
     */
    import { Compiler } from "types:assemblyscript/src/compiler";
    import { Expression, CallExpression, IdentifierExpression, NamedTypeNode } from "types:assemblyscript/src/ast";
    import { Type } from "types:assemblyscript/src/types";
    import { ExpressionRef } from "types:assemblyscript/src/module";
    import { FunctionPrototype, VariableLikeElement, Element } from "types:assemblyscript/src/program";
    import { ReportMode, Resolver } from "types:assemblyscript/src/resolver";
    ...
    export namespace BuiltinNames {
        ...
        const inline_always = "~lib/builtins/inline.always";
    ...
    export class BuiltinTypesContext {
        ...
        constructor(resolver: Resolver, node: NamedTypeNode, ctxElement: Element, ctxTypes: Map<string, Type> | null, reportMode: ReportMode);
    }
    ...
    /** Builtin types map. */
    export const builtinTypes: Map<string, (ctx: BuiltinTypesContext) => Type | null>;
...
declare module "types:assemblyscript/src/module" {
    ...
    export const enum FeatureFlags {
        ...
        Strings = 16384,
        MultiMemory = 32768,
        StackSwitching = 65536,
        SharedEverything = 131072,
        FP16 = 262144,
        BulkMemoryOpt = 524288,
        CallIndirectOverlong = 1048576,
        RelaxedAtomics = 4194304,
        CustomPageSizes = 8388608,
        Multibyte = 16777216,
        WideArithmetic = 33554432,
        All = 67108863
    }
    ...
    export const enum UnaryOp {
        ...
        ExtaddPairwiseI8x16ToI16x8 = 106,
        /** i16x8.extadd_pairwise.i8x16_u */
        ExtaddPairwiseU8x16ToU16x8 = 107,
        /** i32x4.extadd_pairwise.i16x8_s */
        ExtaddPairwiseI16x8ToI32x4 = 108,
        /** i32x4.extadd_pairwise.i64x8_u */
        ExtaddPairwiseU16x8ToU32x4 = 109,
        /** i32x4.trunc_sat_f32x4_s */
        TruncSatF32x4ToI32x4 = 110,
        /** i32x4.trunc_sat_f32x4_u */
        TruncSatF32x4ToU32x4 = 111,
        /** f32x4.convert_i32x4_s */
        ConvertI32x4ToF32x4 = 112,
        /** f32x4.convert_i32x4_u */
        ConvertU32x4ToF32x4 = 113,
        /** i16x8.extend_low_i8x16_s */
        ExtendLowI8x16ToI16x8 = 114,
        /** i16x8.extend_high_i8x16_s */
        ExtendHighI8x16ToI16x8 = 115,
        /** i16x8.extend_low_i8x16_u */
        ExtendLowU8x16ToU16x8 = 116,
        /** i16x8.extend_high_i8x16_u */
        ExtendHighU8x16ToU16x8 = 117,
        /** i32x4.extend_low_i16x8_s */
        ExtendLowI16x8ToI32x4 = 118,
        /** i32x4.extend_high_i16x8_s */
        ExtendHighI16x8ToI32x4 = 119,
        /** i32x4.extend_low_i16x8_u */
        ExtendLowU16x8ToU32x4 = 120,
        /** i32x4.extend_high_i16x8_u */
        ExtendHighU16x8ToU32x4 = 121,
        /** i64x2.extend_low_i32x4_s */
        ExtendLowI32x4ToI64x2 = 122,
        /** i64x2.extend_high_i32x4_s */
        ExtendHighI32x4ToI64x2 = 123,
        /** i64x2.extend_low_i32x4_u */
        ExtendLowU32x4ToU64x2 = 124,
        /** i64x2.extend_high_i32x4_u */
        ExtendHighU32x4ToU64x2 = 125,
        /** f32x4.convert_i32x4_s */
        ConvertLowI32x4ToF64x2 = 126,
        /** f32x4.convert_i32x4_u */
        ConvertLowU32x4ToF64x2 = 127,
        /** i32x4.trunc_sat_f64x2_s_zero */
        TruncSatF64x2ToI32x4Zero = 128,
        /** i32x4.trunc_sat_f64x2_u_zero */
        TruncSatF64x2ToU32x4Zero = 129,
        /** f32x4.demote_f64x2_zero */
        DemoteZeroF64x2ToF32x4 = 130,
        /** f64x2.promote_low_f32x4 */
        PromoteLowF32x4ToF64x2 = 131,
        /** i32x4.relaxed_trunc_f32x4_s */
        RelaxedTruncF32x4ToI32x4 = 132,
        /** i32x4.relaxed_trunc_f32x4_u */
        RelaxedTruncF32x4ToU32x4 = 133,
        /** i32x4.relaxed_trunc_f64x2_s_zero */
        RelaxedTruncF64x2ToI32x4Zero = 134,
        /** i32x4.relaxed_trunc_f64x2_u_zero */
        RelaxedTruncF64x2ToU32x4Zero = 135,
        /** f32x4.promote_low_f16x8 */
        PromoteLowF16x8ToF32x4 = 141,
    ...
    export const enum BinaryOp {
        ...
        NarrowI16x8ToI8x16 = 205,
        /** i8x16.narrow_i16x8_u */
        NarrowU16x8ToU8x16 = 206,
        /** i16x8.narrow_i32x4_s */
        NarrowI32x4ToI16x8 = 207,
        /** i16x8.narrow_i32x4_u */
        NarrowU32x4ToU16x8 = 208,
        /** i8x16.swizzle */
        SwizzleI8x16 = 209,
        /** i8x16.relaxed_swizzle */
        RelaxedSwizzleI8x16 = 210,
        /** f32x4.relaxed_min */
        RelaxedMinF32x4 = 211,
        /** f32x4.relaxed_max */
        RelaxedMaxF32x4 = 212,
    ...
    export class Module {
        ...
        name?: string): ExpressionRef;
        atomic_load(bytes: Index, ptr: ExpressionRef, type: TypeRef, offset?: Index, name?: string, order?: MemoryOrder): ExpressionRef;
        atomic_store(bytes: Index, ptr: ExpressionRef, value: ExpressionRef, type: TypeRef, offset?: Index, name?: string, order?: MemoryOrder): ExpressionRef;
        atomic_rmw(op: AtomicRMWOp, bytes: Index, offset: Index, ptr: ExpressionRef, value: ExpressionRef, type: TypeRef, name?: string, order?: MemoryOrder): ExpressionRef;
        atomic_cmpxchg(bytes: Index, offset: Index, ptr: ExpressionRef, expected: ExpressionRef, replacement: ExpressionRef, type: TypeRef, name?: string, order?: MemoryOrder): ExpressionRef;
        ...
        setPartialInliningIfs(value: number): void;
    ...
    export function getConstValueInteger(expr: ExpressionRef, isWasm64: boolean): i64;
...
declare module "types:assemblyscript/src/ast" {
    ...
    export abstract class Node {
        ...
        static createTupleType(elements: TypeNode[], elementNames: (IdentifierExpression | null)[] | null, isNullable: boolean, range: Range): TupleTypeNode;
...
declare function f64_pow(value: number, exponent: number): number;
/**
...
declare module "types:assemblyscript/src/glue/js/index" {
    /**
     * @fileoverview JavaScript glue code.
     * @license Apache-2.0
     */
    import "types:assemblyscript/std/portable/index";
    import "types:assemblyscript/src/glue/binaryen";
    import "types:assemblyscript/src/glue/js/float";
    import "types:assemblyscript/src/glue/js/i64";
    import "types:assemblyscript/src/glue/js/collections";
}
...
declare module "types:assemblyscript/std/types/portable/index" {
    import "types:assemblyscript/std/portable/index";
}
declare module "types:assemblyscript/std/assembly/shared/feature" {
    /** Indicates specific features to activate. */
...
declare module "types:assemblyscript/src/glue/src/glue/binaryen" {
    /**
     * @fileoverview Portable definitions for Binaryen's C-API.
     *
     * tsc uses the .js file next to it, while asc makes it a Wasm import.
...
declare function offsetof<T>(fieldName?: string): number;
declare function idof<T>(): number;
declare module "types:assemblyscript/src/glue/src/glue/js/index" {
    /**
     * @fileoverview JavaScript glue code.
     * @license Apache-2.0
     */
    import "types:assemblyscript/src/glue/std/portable/index";
    import "types:assemblyscript/src/glue/src/glue/binaryen";
    import "types:assemblyscript/src/glue/src/glue/js/float";
    import "types:assemblyscript/src/glue/src/glue/js/i64";
    import "types:assemblyscript/src/glue/src/glue/js/collections";
}
/**
 * @fileoverview Node.js glue code for TypeScript.
 * @license Apache-2.0
...
declare module "types:assemblyscript/src/glue/std/types/portable/index" {
    import "types:assemblyscript/src/glue/std/portable/index";
}
